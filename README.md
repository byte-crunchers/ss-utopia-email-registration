...
According to different staff the use sign up. Use postman Send a POST request to: http://localhost:8090/api/v1/signup/account or http://localhost:8090/api/v1/signup/card or 
