pipeline {
   options
    ...
    environment {
      ...
      IMAGE_REPO_NAME="ss-utopia-email-registration"
      IMAGE_TAG="latest"
    ...
    stages {       
      ...
      stage('checkout') {
        steps {
          git branch: 'feature_kubernetes', credentialsId: 'git_login', url: 'https://github.com/byte-crunchers/ss-utopia-email-registration.git'
        }
      }
